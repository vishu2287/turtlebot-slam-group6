...
Subsection [Exploration] deals with the exploration strategy. Subsection [Graph SLAM] presents the evolution of the Graph SLAM implementation. Different stages of it are evaluated.
